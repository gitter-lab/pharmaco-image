...
def merge_images(pid, wid, out_dir='./'):
    """
    ...
    for sid in [1, 2, 3, 4, 5, 6]:
        ...
        cv2.imwrite(join(out_dir, "{}_{}_s{}_45.png".format(pid, wid, sid)),
                    cv2.merge([images[4], black_image, images[3]]))
        cv2.imwrite(join(out_dir, "{}_{}_s{}_123.png".format(pid, wid, sid)),
